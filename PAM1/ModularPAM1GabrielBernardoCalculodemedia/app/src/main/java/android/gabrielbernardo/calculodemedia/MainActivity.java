package android.gabrielbernardo.calculodemedia;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calcularMedia() {
        ...
        if(media > 7){
            if(f < 20){
                txtResultado.setTextColor(Color.parseColor("#13E400"));
                txtResultado.setText("Aluno Aprovado com média " + media);
            }else{
                txtResultado.setTextColor(Color.parseColor("#F83527"));
                txtResultado.setText("Excesso de faltas " + f);
